  ...
  describe "Class Methods" do
    ...
    describe "#adult_passengers" do
      it "returns a unique list of all passengers 18 or older" do
        ...
        expect(Passenger.adult_passengers_sorted(@frontier)).to_not match_array(all_frontier_passengers)
        expect(Passenger.adult_passengers_sorted(@frontier)).to match_array(expected_passengers)
      end
    end
  end
end
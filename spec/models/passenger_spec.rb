...
RSpec.describe Passenger do 
  ...
  describe '#get_passenger_flight_id' do 
    it 'get the passenger flight id for a specific flight' do 
      expect(@passenger_1.get_passenger_flight_id(@flight_1)).to eq(@p_flight_1.id)
    end
  end
end